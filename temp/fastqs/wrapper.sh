...
do
  ...
  bsub -n8 -R"span[hosts=1]" -c 99999 -G team_hemberg -q normal -o $TEAM/temp.logs/"output."$1 -e $TEAM/temp.logs/"error."$1 -R"select[mem>100000] rusage[mem=100000]" -M 100000 ./quant.sh $i
done
